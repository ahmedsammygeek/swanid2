...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header text-right">الملتحقين بالمسار</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="panel panel-default">
           ...
           <div class="panel-body">
            <div class="row">
               ...
               $query1 = mysqli_query($connect , "SELECT * FROM applicants WHERE id='$id'");
			   $result = mysqli_fetch_assoc($query1);
               extract($result);
			  $query2 = mysqli_query($connect , "SELECT name FROM tracks WHERE id= '$track_id'");
			...
			<form  role="form" method="post" action="update_track_applicant.php<?php echo "?id=$id"; ?>">
				<label>
					<p>
