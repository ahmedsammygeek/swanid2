...
<section id="contact-page" class="container">
	<div class="row" dir="rtl">
		<div class="col-sm-8">
			...
			<form  method="post" role="form" action="insert_applicant_track.php">
				<label>
					<p>
				...
				<label>
					<p> :الشهادات والدورات الحاصل عليها - إن وجد
					</p>
					<textarea cols="50" rows="4" name="certification"></textarea>
				</label>
				<br>
				<br>
					<label>
					<p>
						:المسار المطلوب الالتحاق به<span id="star">*</span>
					</p>
					<select name="track_id" class="form-control text-right" id="">
						<?php require '../connection/conn.php';
						$query=mysqli_query($connect , "SELECT id,name FROM tracks");
