...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header text-right">الملتحقين بالمناسبه</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="panel panel-default">
           ...
           <div class="panel-body">
            <div class="row">
               ...
               $query1 = mysqli_query($connect , "SELECT * FROM applicants_events WHERE id='$id'");
			...
			<form  role="form" method="post" action="update_event_applicant.php<?php echo "?id=$id"; ?>">
				<label>
					<p>
