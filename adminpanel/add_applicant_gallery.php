...
<section id="contact-page" class="container">
	<div class="row" dir="rtl">
		<div class="col-sm-8">
			...
			<form method="post" role="form" action="insert_applicant_gallery.php">
				<label>
					<p>
				...
				<label>
					<p>
						:كيفيه المشاركة في المعرض<span id="star">*</span>
					</p>
					<select name="how" class="form-control text-right" id="">
						<option value="1">زيارة طلاب أو منسوبي الكليه</option>
						<option value="2">زياره من خارج منسوبي الكليه</option>
						<option value="3">عرض جهاز أو منتج للعرض</option>
						<option value="4">غير ذلك</option>
					</select>
				</label>
				<br>
				...
				<label>
					<p>
						:المعرض المطلوب الالتحاق به<span id="star">*</span>
					</p>
					<select name="gallery_id" class="form-control text-right" id="">
						<?php require '../connection/conn.php';
						$query=mysqli_query($connect , "SELECT id,title FROM gallery");
