        ...
        <div class="panel-body">
          <div class="row">
            <div class="col-lg-12">
             ...
             <form role="form" method="post" action="insert_award.php">
              ...
              <div class="form-group">
                <textarea name="content"  placeholder="المحتوى" class="form-control" id="" cols="30" rows="10"></textarea>
              </div>
              <div class="form-group">
                <label>الايفنت المقدمه فيه</label>
