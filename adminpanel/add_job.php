        ...
        <div dir="rtl" class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form role="form" method="post" action="insert_job.php">
                                <div class="form-group">
            
                                    <input type="text" name="title" placeholder="ادخل عنوان الوظيفة هنا" class="form-control">
                                   
                                </div>
                                <div class="form-group">
                                    <textarea type="text" name="content" class="form-control" placeholder="ادخل معلومات الوظيفة هنا"></textarea>
                                </div>
