...
<section id="contact-page" class="container">
	<div class="row" dir="rtl">
		<div class="col-sm-8">
			...
			<form  method="post" role="form" action="insert_applicant_career.php">
				<label>
					<p>
				...
				<label>
					<p>
						:الوظيفة المطلوب الالتحاق به<span id="star">*</span>
					</p>
					<select name="career_id" class="form-control text-right" id="">
						<?php require '../connection/conn.php';
						$query=mysqli_query($connect , "SELECT id,title FROM careers");
